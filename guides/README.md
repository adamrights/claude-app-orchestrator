...
- [resuming-builds.md](resuming-builds.md) — Multi-session builds: the Build Map journal, `/resume`, and decision escalation
- [adding-templates.md](adding-templates.md) — How to add a new starter template
- [adding-skills.md](adding-skills.md) — How to extend the knowledge base with a new skill
